...
export default function Abstract() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Header banner */}
      <div className="border-b py-16 relative overflow-hidden bg-background">
        <motion.div
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">{t("abstractTitle")}</h1>
